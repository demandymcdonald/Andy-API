...
local function buy()
    local function bf()
        ...
        additem(6, "Template: ATM", 4000, "give " .. un .. " minecraft:allthemodium_upgrade_smithing_template")
        additem(7, "Template: ATM", 6000, "give " .. un .. " minecraft:vibranium_upgrade_smithing_template")
        additem(8, "Template: ATM", 8000, "give " .. un .. " minecraft:unobtanium_upgrade_smithing_template")
        additem(9, "Template: Sentry", 500, "give " .. un .. " minecraft:sentry_armor_trim_smithing_template")
        additem(10, "Template: Vex", 500, "give " .. un .. " minecraft:vex_armor_trim_smithing_template")
        additem(11, "Template: Wild", 500, "give " .. un .. " minecraft:wild_armor_trim_smithing_template")
        additem(12, "Template: Coast", 500, "give " .. un .. " minecraft:coast_armor_trim_smithing_template")
        w_Main.clear()
        local mx, my = w_Main.getSize()
        w_Main.setCursorPos(1, 1)
...
local function mainmenu()
    ...
    local function operationtimeout()
        aapi.inactivitytimer("AS_Operation", 500)
        rtm = true
    end
